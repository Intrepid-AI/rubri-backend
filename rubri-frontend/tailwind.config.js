...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Dark Theme Brand Colors - Professional Blue Palette
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Semantic Colors for Enterprise UI
        success: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
        ...
        // Surface Colors (responsive to dark/light mode)
        surface: {
        ...
        // Background Colors (responsive to dark/light mode)
        background: {
        ...
        // Text Colors (responsive to dark/light mode)
        foreground: {
        ...
        // Border Colors (responsive to dark/light mode)
        border: {
      ...
      // Professional Font Sizes with Line Heights
      fontSize: {
      ...
      boxShadow: {
        ...
        // Colored Shadows for State Indication
